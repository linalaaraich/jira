# Sprint 2 Extension — Jira Reference

15 new items (2 epics + 13 stories) for the SCRUM project, sprint 2 extended to **23 April 2026**.

## Files in this repo

| File | Purpose |
|---|---|
| `Jira.csv` | Original Jira export (existing project state) |
| `Jira-additions.csv` | CSV ready to import — 15 new items in 13 columns |
| `SPRINT2-EXTENSION-README.md` | Manual steps for things CSV import can't do (rescoping/closing existing tickets, fixing imported field gaps) |
| `EPICS-AND-STORIES.md` | Compact human-readable inventory |
| **`README.md`** (this file) | **Copy-paste ready descriptions for each new item** |
| `generate_additions.py` | The script that builds `Jira-additions.csv` |

## How to use this file

The CSV import worked but **3 fields didn't carry over** (Sprint, Story Points, Due date) because of Jira's import quirks. To fix them quickly:

1. Open each imported item in Jira
2. **Copy the fenced block below into the Description field** — it ends with a metadata footer listing the exact values for Story Points, Sprint, and Due date
3. Set those 3 fields in the Jira UI based on the footer values
4. Save

The metadata above each block (Type, Priority, Points, Parent, Labels) is just for visual reference — those fields already imported correctly.

---

# Epic 3 — Kubernetes Migration of Monitored Target

**Type:** Epic · **Priority:** High · **Labels:** Kubernetes · **Work item Id:** `EPIC3` · **Due:** 23 Apr 2026
...
## E3-01: Bootstrap k3s on EC2 via Ansible — xanmanning.k3s, pinned, Traefik disabled

**Type:** Story · **Priority:** Highest · **Points:** 3 · **Parent:** `EPIC3` · **Labels:** Kubernetes
...
## E3-03: Helm chart — Spring Boot backend (Deployment + Service + ConfigMap + probes)

**Type:** Story · **Priority:** High · **Points:** 3 · **Parent:** `EPIC3` · **Labels:** Kubernetes
...
## E3-04: Helm chart — Kong via upstream chart, DB-less mode, kong.yml as ConfigMap
...
## E3-05: Helm chart — AI stack (triage service + 5 MCP servers + Ollama)

**Type:** Story · **Priority:** High · **Points:** 5 · **Parent:** `EPIC3` · **Labels:** Kubernetes
...
**Type:** Story · **Priority:** Highest · **Points:** 5 · **Parent:** `EPIC3` · **Labels:** Kubernetes
...
## E3-07: In-cluster OTel Collector DaemonSet — log/trace forwarding to monitoring VM
...
## E3-08: Prometheus kubernetes_sd_configs scrape job + RBAC for monitoring VM
...
## E3-10: End-to-end K8s validation playbook — full pipeline against K8s target
...
**Type:** Epic · **Priority:** Medium · **Labels:** AI · **Work item Id:** `EPIC4` · **Due:** 23 Apr 2026
...
**Type:** Story · **Priority:** Highest · **Points:** 3 · **Parent:** `EPIC4` · **Labels:** AI
...
Story Points: 3
Estimate: 0.5 day
Epic: Epic 4 -- AI Triage Service Hardening
Sprint: SCRUM Sprint 2
Due date: 23 Apr 2026
Blocks: (none)
Blocked by: (none) — independent of K8s migration
```

---

## AI-02: JSON schema enforcement on LLM verdict — Ollama JSON mode + Pydantic validator

**Type:** Story · **Priority:** Highest · **Points:** 2 · **Parent:** `EPIC4` · **Labels:** AI
...
Due date: 23 Apr 2026
Blocks: (none)
Blocked by: AI-01 (uses its NEEDS_HUMAN_REVIEW fallback path)
```

---

## AI-03: Triage service self-observability — /metrics with queue depth, latency, error rates

**Type:** Story · **Priority:** High · **Points:** 3 · **Parent:** `EPIC4` · **Labels:** AI
...
| | Count | Points |
|---|---|---|
| Epic 3 — K8s Migration | 1 epic + 10 stories | 34 |
| Epic 4 — AI Triage Hardening | 1 epic + 3 stories | 8 |
| **Total new** | **2 epics + 13 stories** | **42** |

# Critical path (sequencing for the spine)

```
SCRUM-63 (Terraform) ──► E3-01 ──┬─► E3-06 (NVIDIA spike)
                                  │
                          E3-02 ──┤
                                  ▼
                          E3-03 ──┐
...
AI-01, AI-02, AI-03 ──► independent of K8s, run anytime
```

For the manual rescoping/closing of existing tickets (SCRUM-63, 64, 65, 66, 82) and post-import sprint metadata fixes, see [`SPRINT2-EXTENSION-README.md`](SPRINT2-EXTENSION-README.md).
